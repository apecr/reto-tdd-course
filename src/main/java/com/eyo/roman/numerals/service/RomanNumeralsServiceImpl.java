...
public class RomanNumeralsServiceImpl implements RomanNumeralsService {
     ...
     * 
     * @param ten {@link String} con la potencia de diez por encima del numero (si es el 9, X [10], p.e.)
     * @param five {@link String} con el valor intermedio de la potencia de diez por encima (si es el 90, L [50], p.e.)
     * @param one {@link String} con el valor de la unidad que estamos midiendo potencia de 10 (si el 900, C [100], p.e)
     * @param numberMinusThanTen El valor multiplicador de la potencia de 10 (si es 9 --> 9, si es 90 --> 0, si es 900 --> 9)
    ...
    private String getRomanNumeralFromSimpleNumberMinusThanTen(String ten, String five, String one,
        ...
        if (numberMinusThanTen > 5) {
            output = five + repeatString( one, 5 - numberMinusThanTen );
        }
        return output;
    }
